...
export const ViewCollectionButton: React.FC<ViewCollectionButtonProps> = ({ 
  ...
  return (
    <div 
      className={`absolute right-[-1%] bottom-[-50%] h-[200px] w-[200px] cursor-pointer ${className}`}
      onClick={onClick}
    >
      <svg
      ...
      <span className="absolute right-[-10%] bottom-[-58%] text-white text-xs font-semibold tracking-[0.3em]">
        View Collection
      </span>
    </div>
  );
